...
public class UpdateADExternalAccounts implements PostProcessHandler, ConditionalEventHandler {

	private final static String className = UpdateADExternalAccounts.class.getName();
	...
	public EventResult execute(long processId, long eventId, Orchestration orchestration) {
		...
		System.out.println("EventResult - Execute: UpdateADExternalAccounts.");
		try {
				...
				if (!userKey.isEmpty()) {
					...
					if (resourceAccount != null) {
						...
						if (!modParentData.isEmpty()) {
							logger.info("Some information must be updated in External AD for User Key: " + userKey);
		...
		logger.exiting(className, "execute UpdateADExternalAccounts");
	...
	public BulkEventResult execute(long processId, long eventId, BulkOrchestration orchestration) {
		...
		System.out.println("BulkEventResult - Execute: UpdateADExternalAccounts.");
		try {
