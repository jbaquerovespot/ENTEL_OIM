...
// Initiation
trace.ok("[Insert Child SGA] Attributes::"+attributes);
        ...
        for( iterator = childDataEOSet.iterator(); iterator.hasNext(); )
        {
            ...
            if(superattr!=null)
            {
                ...
                if (response == null){
                	...
                	//Error
                  // Throw exception
                  throw new ConnectorException("[Insert Child SGA] Error: Unexpected error calling to the webservice");
                
                } else if (response.getCodigo() == "0000") {
                
                  trace.info("[Insert Child SGA] Insert Child Success: $UID");
                  ...
                  // Error
                  // Throw exception
                  throw new ConnectorException("[Insert Child SGA] Error: Webservice error code: "+ response.getCodigo() + "Webservice error message: "+response.getDescripcion());
