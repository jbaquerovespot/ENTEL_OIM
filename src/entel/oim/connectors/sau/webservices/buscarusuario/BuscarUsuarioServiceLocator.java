...
public class BuscarUsuarioServiceLocator extends org.apache.axis.client.Service implements entel.oim.connectors.sau.webservices.buscarusuario.BuscarUsuarioService {
    ...
    public entel.oim.connectors.sau.webservices.buscarusuario.BuscarUsuarioPorType getBuscarUsuarioPort() throws javax.xml.rpc.ServiceException {
    ...
    public entel.oim.connectors.sau.webservices.buscarusuario.BuscarUsuarioPorType getBuscarUsuarioPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            entel.oim.connectors.sau.webservices.buscarusuario.BuscarUsuarioBindingStub _stub = new entel.oim.connectors.sau.webservices.buscarusuario.BuscarUsuarioBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (entel.oim.connectors.sau.webservices.buscarusuario.BuscarUsuarioPorType.class.isAssignableFrom(serviceEndpointInterface)) {
                entel.oim.connectors.sau.webservices.buscarusuario.BuscarUsuarioBindingStub _stub = new entel.oim.connectors.sau.webservices.buscarusuario.BuscarUsuarioBindingStub(new java.net.URL(BuscarUsuarioPort_address), this);
                _stub.setPortName(getBuscarUsuarioPortWSDDServiceName());
                return _stub;
            }
        }
